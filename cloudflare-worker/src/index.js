...
export default {
  ...
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      // The M/W/F GBP photo pipeline (PhotoQueue + tagging + scheduler + posting
      // card + gbp-thumb/gbp-processed R2) was REMOVED 2026-07-31: Google
      // deprecated the photo-upload API for standard profiles, so it could never
      // auto-post — the only reason it existed. The crew/job photo system
      // (/photos, /admin/photos/*, env.PHOTOS) is a DIFFERENT system and is
      // untouched. Archive: snapshots/photoqueue_final_2026-07-31.md
